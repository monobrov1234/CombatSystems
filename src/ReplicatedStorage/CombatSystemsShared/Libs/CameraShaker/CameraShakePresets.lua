...
local CameraShakePresets = {
	...
	-- Should happen once.
	GunRecoil = function()
		local c = CameraShakeInstance.new(1, 4, 0.1, 0.1)
	...
	Bump = function()
		local c = CameraShakeInstance.new(2.5, 4, 0.1, 0.5)
		c.PositionInfluence = Vector3.new(0.15, 0.15, 0.15)
		c.RotationInfluence = Vector3.new(1, 1, 1)
		return c
	end,
	...
	smallExplosion = function()
		local c = CameraShakeInstance.new(2, 4, 0, 0.25)
		c.PositionInfluence = Vector3.new(0.25, 0.25, 0.25)
		c.RotationInfluence = Vector3.new(4, 1, 1)
		return c
	end,

	mediumExplosion = function()
		local c = CameraShakeInstance.new(3, 6, 0, 0.25)
		c.PositionInfluence = Vector3.new(0.25, 0.25, 0.25)
		c.RotationInfluence = Vector3.new(4, 1, 1)
		return c
	end,
	...
	bigExplosion = function()
		local c = CameraShakeInstance.new(5, 10, 0, 0.25)
		c.PositionInfluence = Vector3.new(0.25, 0.25, 0.25)
		c.RotationInfluence = Vector3.new(4, 1, 1)
		return c
	end,
