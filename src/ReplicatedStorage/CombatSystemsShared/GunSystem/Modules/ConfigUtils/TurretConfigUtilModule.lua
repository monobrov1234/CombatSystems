...
-- FINALS
local turretConfigs = ReplicatedStorage.CombatSystemsShared.GunSystem.Configs.TurretConfigs
local defaultConfig = require(turretConfigs.Default.DefaultConfig)
export type DefaultType = typeof(defaultConfig)

-- STATE
local inheritConfigs: { [ModuleScript]: {} } = {}
...
function module.getConfig(turretName: string): DefaultType
	return inheritConfigs[turretName]
end
